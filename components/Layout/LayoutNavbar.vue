                ...
                <v-col xl="6" lg="6" md="8" sm="10" xs="10">
                  <div class="max-[960px]:tw-flex min-[960px]:tw-hidden">
                    ...
                    <v-menu 
                      ...
                      <v-card v-if="!authStore.isUserLoggedIn" :loading.sync="isLoggingIn" style="background: rgb(50, 17, 102); padding: 0.5rem;">
                      ...
                      <v-card v-if="authStore.isUserLoggedIn" style="background: rgb(50, 17, 102); padding: 0.5rem;">
...
export default {
    ...
    mounted(){
      window.addEventListener("keypress", this.handleLoginEnterEvent);
    },
    beforeDestroy() {
      window.removeEventListener("keypress", this.handleLoginEnterEvent);
    },
    watch: {
    ...
    methods: {
      async handleLoginEnterEvent(event) {
      ...
      async logout() {
        ...
        const refreshToken = useCookie("JWT-Refresh");
