                    ...
                    <div class="max-[960px]:tw-flex min-[960px]:tw-hidden">
                      ...
                      <v-menu 
                        ...
                        <v-card v-if="authStore.isLoggedIn" style="background: rgb(50, 17, 102); padding: 0.5rem;">
                          ...
                          <v-card-text>
                            <v-btn color="primary" rounded="xl" variant="outlined" to="/account/dashboard" class="tw-w-full tw-normal-case tw-m-1" style="text-transform: none;"><div class="tw-text-purple-50">Dashboard</div></v-btn>
